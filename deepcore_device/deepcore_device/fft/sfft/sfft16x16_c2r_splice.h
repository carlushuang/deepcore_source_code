...
#define FLIP_X_sfft16x16_c2r_splice(x) (x)
#   else
#define FLIP_X_sfft16x16_c2r_splice(x) ((16-x)&15)
#   endif
#else
#define FLIP_X_sfft16x16_c2r_splice(x) ((16-x)&15)
#endif
...
__global__ void LB_16x16_128 dk_sfft16x16_c2r_splice##suffix(\
          float *              d_r,    \
...
{                                      \
    ...
    unsigned int flip_x=FLIP_X_sfft16x16_c2r_splice(x); \
