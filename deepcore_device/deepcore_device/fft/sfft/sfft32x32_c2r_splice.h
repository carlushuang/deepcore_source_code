...
#define FLIP_X_sfft32x32_c2r_splice(x) (x)
#   else
#define FLIP_X_sfft32x32_c2r_splice(x) ((32-x)&31)
#   endif
#else
#define FLIP_X_sfft32x32_c2r_splice(x) ((32-x)&31)
#endif

#define sfft32x32_c2r_splice(dir,suffix)        \
__global__ void dk_sfft32x32_c2r_splice##suffix(\
          float *              d_r,    \
...
{                                      \
    ...
    unsigned int flip_x=FLIP_X_sfft32x32_c2r_splice(x);    \
...
sfft32x32_c2r_splice(-1,)
sfft32x32_c2r_splice(-1,_relu)
sfft32x32_c2r_splice( 0,_bias)
sfft32x32_c2r_splice( 0,_bias_relu)
sfft32x32_c2r_splice( 1,_drelu)
sfft32x32_c2r_splice( 1,_xdrv)