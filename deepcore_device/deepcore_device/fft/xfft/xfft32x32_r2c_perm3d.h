__global__ void LB_32x32_512 dk_xfft32x32_r2c_perm3d( float2* d_c, 
...
__global__ void LB_32x32_512 dk_xfft32x32_r2c_perm3d_ext( float2* d_c, 
    const __half* __restrict__ d_r, const float* __restrict__ d_RF, 
    unsigned int nx, unsigned int ny, unsigned int ldc, unsigned int ldr, unsigned int n_cells, int dir )
{
    const int brev[]={0,8,4,12,2,10,6,14,1,9,5,13,3,11,7,15};
...
__global__ void LB_32x32_512 dk_xfft32x32_r2c_perm3d_pad( float2* d_c, 
    const __half* __restrict__ d_r, const float* __restrict__ d_RF, 
...
__global__ void LB_32x32_512 dk_xfft32x32_r2c_perm3d_flip( float2* d_c, 
    const __half* __restrict__ d_r, const float* __restrict__ d_RF, 
    unsigned int nx, unsigned int ny, unsigned int ldc, unsigned int ldr, unsigned int n_cells, int dir )
{
    const int brev[]={0,8,4,12,2,10,6,14,1,9,5,13,3,11,7,15};
